  ...
  return (
    <>
      ...
      <div className="grid grid-cols-4 gap-4">
        ...
        <StatCard label="Productos activos" value={String(activeProducts)} change={0} icon={Package} color="rose" />
      </div>
  ...
  useEffect(() => {
    async function loadData() {
      try {
        ...
        showToast('No se pudo conectar con el servidor/MongoDB', 'error')
        console.error(err)
      } finally {
        setLoading(false)
      }
